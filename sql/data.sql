...
/* CO_Envoi-commandes */
INSERT INTO llx_c_email_templates (entity,module,type_template,lang,private,fk_user,datec,label,position,enabled,active,topic,content,content_lines,joinfiles)
VALUES (0,'commande','order_send','',0,null,null,'(SendingEmailOnShippingOfOrder)',150,'$conf->commande->enabled',1,'[__[MAIN_INFO_SOCIETE_NOM]__] __(ShippingOfOrder)__','__(Hello)__,<br><br>\n\n__(HereIsYourOrder)__<br><br>\n__(Sincerely)__<br><br>\n\n__(AdministrativeService)__<br>__MYCOMPANY_NAME__<br>\n__MYCOMPANY_FULLADDRESS__<br>\n__MYCOMPANY_EMAIL__',null, 0);

/* CO_Accusé-reception-commandes */
INSERT INTO llx_c_email_templates (entity,module,type_template,lang,private,fk_user,datec,label,position,enabled,active,topic,content,content_lines,joinfiles)
VALUES (0,'commande','order_send','',0,null,null,'(SendingEmailOnDeliveryReceipt)',160,'$conf->commande->enabled',1,'[__[MAIN_INFO_SOCIETE_NOM]__] __(DeliveryReceipt)__ __PROJECT_NAME__','__(Hello)__,<br><br>\n\n__(YourOrderIsRegistred)__<br><br>\n__(Sincerely)__<br><br>\n\n__(AdministrativeService)__<br>__MYCOMPANY_NAME__<br>\n__MYCOMPANY_FULLADDRESS__<br>\n__MYCOMPANY_EMAIL__',null, 0);

/* CO_Facturation-commandes */
INSERT INTO llx_c_email_templates (entity,module,type_template,lang,private,fk_user,datec,label,position,enabled,active,topic,content,content_lines,joinfiles)
VALUES (0,'commande','order_send','',0,null,null,'(SendingEmailOnOrderBilling)',170,'$conf->commande->enabled',1,'[__[MAIN_INFO_SOCIETE_NOM]__] __(OrderBilling)__ __REF_CLIENT__','__(Hello)__,<br><br>\n\n__(HereIsOrderBill)__<br><br>\n__(Sincerely)__<br><br>\n\n__(AdministrativeService)__<br>__MYCOMPANY_NAME__<br>\n<br>__MYCOMPANY_FULLADDRESS__<br>\n__MYCOMPANY_EMAIL__',null, 0);
...
INSERT INTO llx_c_email_templates (entity,module,type_template,lang,private,fk_user,datec,label,position,enabled,active,topic,content,content_lines,joinfiles)
VALUES (0,'supplier_proposal','supplier_proposal_send','',0,null,null,'(SendingEmailOnEndOfCommercialAsk)',210,'$conf->supplier_proposal->enabled',1,'[__[MAIN_INFO_SOCIETE_NOM]__] __(EndOfCommercialAsk)__','__(Hello)__ ,<br><br>\n\n__(DeniedCostAreOverBudget)__<br><br>\n__(Sincerely)__<br><br>\n\n__(AdministrativeService)__<br>__MYCOMPANY_NAME__<br>\n__MYCOMPANY_FULLADDRESS__<br>\n__MYCOMPANY_EMAIL__',null, 0);
...
/* FA_Envoi-facture */
INSERT INTO llx_c_email_templates (entity,module,type_template,lang,private,fk_user,datec,label,position,enabled,active,topic,content,content_lines,joinfiles)
VALUES (0,'facture','facture_send','',0,null,null,'(SendingEmailOnBill)',260,'$conf->facture->enabled',1,'[__[MAIN_INFO_SOCIETE_NOM]__] __(Bill)__ __REF__','__(Hello)__,<br><br>\n\n__(HereIsOrderBill)__<br><br>\n__(Sincerely)__<br><br>\n\n__(AdministrativeService)__<br>__MYCOMPANY_NAME__<br>\n__MYCOMPANY_FULLADDRESS__<br>\n__MYCOMPANY_EMAIL__',null, 1);
